...
public class SubProblem {
    ...
    public void BuildChenModel(ArrayList<Integer> itemsId, int bag) throws IloException {
...
//        System.out.println(itemsId + "," + bag);
//        IloNumVar[] x, y, z;
...
//    }
    ...
    public ArrayList<Position> getChenModelResults(ArrayList<Integer> itemsId, int bag) throws IloException {
        ArrayList<Position> positions=new ArrayList<>();
        int itemsCount = itemsId.size();
        ArrayList<Bag> allBags = instance.getAllBags();
        ArrayList<Item> allItems = instance.getAllItems();
        double[] xx, yy, zz, lx, ly, lz,  length, width, height;
        double LL,WW,HH;
        xx = sub.getValues(x);
        yy = sub.getValues(y);
        zz = sub.getValues(z);
